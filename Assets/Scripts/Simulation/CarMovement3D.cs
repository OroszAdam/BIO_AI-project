...
public class CarMovement3D : MonoBehaviour
{
    ...
    private CarController3D controller;
    ...
    void Start()
    {
        controller = GetComponent<CarController3D>();
    }
    #endregion
...
/*     void OnCollisionEnter()
    ...
    private void OnTriggerEnter(Collider other) {
        // Layer 8 is the layer of "Wall" gameobjects
        if (HitWall != null && other.gameObject.layer == 8 )
            HitWall();
    }
